(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('isomorphic-fetch'), require('@potatosalad/magnus'), require('apollo-client/transport/batching'), require('apollo-client/transport/networkInterface')) :
	typeof define === 'function' && define.amd ? define(['exports', 'isomorphic-fetch', '@potatosalad/magnus', 'apollo-client/transport/batching', 'apollo-client/transport/networkInterface'], factory) :
	(factory((global.GraphQLMagnus = global.GraphQLMagnus || {}),global.fetch,global.magnus,global.apolloClient_transport_batching,global.apolloClient_transport_networkInterface));
}(this, (function (exports,fetch,magnus,apolloClient_transport_batching,apolloClient_transport_networkInterface) { 'use strict';
...
exports.GraphQLHTTPFetchNetworkInterface = GraphQLHTTPFetchNetworkInterface;
exports.GraphQLHTTPBatchedNetworkInterface = GraphQLHTTPBatchedNetworkInterface;
exports.createGraphQLNetworkInterface = createGraphQLNetworkInterface;
